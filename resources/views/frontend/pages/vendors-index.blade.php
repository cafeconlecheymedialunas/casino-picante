...
<style>
    ...
    .vpi-card::after { content: ""; position: absolute; top: 0; left: 0; right: 0; height: 170px; background: var(--card-portrait, none); background-size: cover; background-position: center top; opacity: .5; -webkit-mask-image: linear-gradient(180deg, black 40%, transparent 100%); mask-image: linear-gradient(180deg, black 40%, transparent 100%); pointer-events: none; z-index: 0; }
