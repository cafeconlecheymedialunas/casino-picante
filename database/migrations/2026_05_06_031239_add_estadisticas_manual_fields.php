...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('lines', function (Blueprint $table) {
            $table->string('mejor_mes')->nullable()->after('perfil_url');
            ...
            $table->decimal('porcentaje_encargado', 5, 2)->nullable()->default(0);
        });
    }
    ...
    {
        Schema::table('lines', function (Blueprint $table) {
            $table->dropColumn(['mejor_mes', 'mejor_mes_total', 'mejor_plataforma', 'mejor_plataforma_total', 'ventas_mes_actual', 'ventas_mes_pasado', 'ventas_mes_antiguo', 'ganancia_encargado', 'porcentaje_encargado']);
        });
    }
};
